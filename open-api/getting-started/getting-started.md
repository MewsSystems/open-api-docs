...
Take a look at [The Mews APIs](the-mews-apis.md) to see which is the API for you. The documentation for each API includes examples of common use cases for that API, or you can find an overview of all of them in [Use Cases](/broken/pages/3lElhhVxfB2LdIwAyekt).
...
* [Go straight to the Mews POS API](https://app.gitbook.com/s/fOtD4bwkCg5dMG01D7h0/)
