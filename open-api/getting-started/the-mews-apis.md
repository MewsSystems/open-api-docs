...
> * [Mews Booking Engine API](the-mews-apis.md#mews-booking-engine-api)
...
* For the full documentation, see [Mews Connector API](/connector-api/)
...
* For the full documentation, see [Mews Channel Manager API](/channel-manager-api/)
...
* For the full documentation, see [Mews Booking Engine API](/booking-engine-guide/)
...
If you are a Channel Manager, or a bulk sales or distribution channel such as an Online Travel Agent, then you will want the [Mews Channel Manager API](/channel-manager-api/). If you are implementing a Booking Engine for your customers to book with you directly, you will want the [Mews Booking Engine API](/booking-engine-guide/). For all other use cases, use the [Mews Connector API](/connector-api/). Please also take a look at [Use Cases](/broken/pages/MJwQvFPVBro8nQ0WvpCR), where you can find more information on individual use cases and links to more details in the documentation for the appropriate API.
