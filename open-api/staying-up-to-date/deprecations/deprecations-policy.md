...
* [Why we have this policy](deprecations-policy.md#why-we-have-this-policy)
* [What do we mean by deprecated?](deprecations-policy.md#what-do-we-mean-by-deprecated)
* [What we deprecate and why](deprecations-policy.md#what-we-deprecate-and-why)
* [When we deprecate](deprecations-policy.md#when-we-deprecate)
* [How we deprecate](deprecations-policy.md#how-we-deprecate)
* [How long is the stoppage notice period?](deprecations-policy.md#how-long-is-the-stoppage-notice-period)
* [How deprecations are communicated](deprecations-policy.md#how-deprecations-are-communicated)
* [As a user, what should I do?](deprecations-policy.md#as-a-user-what-should-i-do)
* [Deprecations and versioning](deprecations-policy.md#deprecations-and-versioning)
* [Questions and feedback](deprecations-policy.md#questions-and-feedback)
...
* **Non-breaking changes**\
  `Non-breaking changes` are changes that should _not_ impact your current implementation, regardless of what features you use.
...
As to the why, we deprecate features because we need to make breaking changes and this is a way to let you know that you should change your implementation, and to give you time to do so - see [Why we have this policy](deprecations-policy.md#why-we-have-this-policy).
...
These are considered non-breaking changes, in other words changes that do not require any change to legacy implementations for their continued working. Deprecations are planned breaking changes, i.e. a statement that we intend to make a breaking change. We plan it so that any such change does not produce unexpected behaviour (see [As a user, what should I do?](deprecations-policy.md#as-a-user-what-should-i-do)) and we follow a clear deprecation process (see [How we deprecate](deprecations-policy.md#how-we-deprecate)) to keep you informed and allow you to implement the necessary changes to your implementation.
