...
* **Client Token**: This token is provided by Mews and is essential for authenticating your Channel Manager application. Once we have created your integration profile, you will receive an automatic email containing your clientToken.
* **Connection Token**: This token is specific to each connection with a property. You can obtain it in four ways:
  * **Using the API**: Automatic (recommended) : If your application supports [Mews: /changeNotification](../channel-manager-operations/notifications.md), you will receive an API notification to this endpoint when the property first connects, which contains their unique connectionToken.
