...
If your primary need is syncing customer or reservation data with Mews as a generic CRM, use the [Connector API](https://app.gitbook.com/o/-L8h68VsCrKuC0pX9qyf/s/8QGgEdFlLPx3GworPLr8/) instead.
