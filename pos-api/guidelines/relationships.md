...
**Mews POS API**, as per the JSON:API specification, supports inclusion of related resources (see [Relationships](relationships.md#relationships) above) through the `include` query parameter.
