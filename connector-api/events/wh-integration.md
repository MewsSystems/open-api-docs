...
| `Requestor`   | [Requestor](wh-integration.md#requestor)     | optional | Person requesting the action or event. Not null when integration created by a known user; otherwise null.    |
