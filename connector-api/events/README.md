...
To start using API Events, configure your system to receive event notifications and [Contact support](../contact-support/README.md) to register your Webhook or WebSocket.
