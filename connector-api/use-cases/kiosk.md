...
| How to get the list of open revenue items for a guest | [Get all payments], [Get all order items] |
...
If the guest has a credit card on file, you can charge the card by specifying the card and the amount.
