...
To test your workflow implementation with an actual Mews Terminal device, please [contact support](../contact-support/README.md). They will supply you with the necessary details to connect to a test configuration:
...
If you still require assistance, please [contact support](../contact-support/README.md).
